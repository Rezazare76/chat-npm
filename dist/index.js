...
exports.Chat = (0, react_1.memo)(({ className, greetingMessage, messageList, positions, dir, logo, onChange, clear, }) => {
    ...
    return (react_2.default.createElement("main", { className: "chat-bot", style: {
        ...
        react_2.default.createElement("span", { className: " cursor-pointer rounded-full bg-[#632AE8] p-3 text-[#eeeeee]", onClick: () => {
                setFullScreen(false);
        ...
        showChat && (react_2.default.createElement("section", { className: `${className} ${dir} ${fullScreen} chatbot-container  absolute flex   flex-col
             overflow-hidden rounded bg-[#fcfcfc] outline-[#632AE8] `, onKeyDown: handleKeyPress },
            showChat == "welcome" && (react_2.default.createElement("div", { className: "welcome absolute flex h-full w-full flex-col items-center justify-center " },
                ...
                react_2.default.createElement("div", { className: "rounded-full bg-white bg-opacity-10 p-1 shadow-xl" },
                    react_2.default.createElement("div", { className: "rounded-full bg-white bg-opacity-30 p-1" },
                ...
                react_2.default.createElement("button", { className: "mt-10 rounded bg-white px-5 py-1 text-[#632AE8]", onClick: () => setShowChat("chat") }, "Start Chat!"))),
            react_2.default.createElement("header", { className: "flex justify-between p-2 text-[#632AE8]" },
            ...
            react_2.default.createElement("ul", { className: "chat-messages  flex h-full flex-grow  flex-col", ref: chatContainerRef },
                react_2.default.createElement("li", { className: "flex w-full  items-end" },
                    react_2.default.createElement("i", { className: "mx-2 rounded-full bg-[#eeeeee] p-2 text-[#632AE8]" },
                        react_2.default.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", fill: "currentColor", width: 20 },
                            react_2.default.createElement("path", { d: data_1.icons.bot }))),
                    react_2.default.createElement("div", { className: `w-60 rounded rounded-tl-none bg-[#eeeeee] p-3 text-[#632AE8]` }, greetingMessage)), list === null || list === void 0 ? void 0 :
                list.map((message, index) => (react_2.default.createElement("li", { key: index, className: `flex w-full  items-end ${message.position === "user" && "flex-row-reverse self-end "}` },
                    message.position == "bot" && (react_2.default.createElement("i", { className: "mx-2 rounded-full bg-[#eeeeee] p-2 text-[#632AE8]" },
                        react_2.default.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", fill: "currentColor", width: 20 },
                            react_2.default.createElement("path", { d: data_1.icons.bot })))),
                    react_2.default.createElement("div", { className: `w-60 rounded p-3  ${message.position === "user"
                        ...
                        react_2.default.createElement("div", { className: `mt-2 flex flex-row-reverse items-center  text-xs text-[#eeeeee]` },
                            ...
                            message.time)))))),
            react_2.default.createElement("aside", { className: " m-1 mt-0 rounded bg-[#632AE8] p-1" },
                react_2.default.createElement("div", { className: "flex items-center rounded-md bg-[#eeeeee] bg-opacity-15 px-2 text-[#eeeeee]" },
                    ...
                    react_2.default.createElement("div", { className: "file-picker  cursor-pointer  overflow-hidden" },
